    ...
    [
      _c(
        ...
        [
          ...
          _c(
            "free-confirm",
            { ref: "nicknameConfirm", attrs: { title: "修改昵称" } },
            [
              _c("u-input", {
                ...
                on: {
                  input: function($event) {
                    _vm.newNickname = $event.detail.value.trim()
                  }
                }
              })
            ],
          ...
          _c(
            "free-confirm",
            { ref: "usernameConfirm", attrs: { title: "修改账号" } },
            [
              _c("u-input", {
                staticClass: ["border-bottom", "font-md", "text-muted"],
                staticStyle: { height: "90rpx" },
                ...
                on: {
                  input: function($event) {
                    _vm.newUsername = $event.detail.value.trim()
                  }
                }
              })
            ],
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _freeNavBar = _interopRequireDefault(__webpack_require__(/*! @/components/free-ui/free-nav-bar.vue */ 22));\nvar _freeListItem = _interopRequireDefault(__webpack_require__(/*! @/components/free-ui/free-list-item.vue */ 39));\nvar _freeAvatar = _interopRequireDefault(__webpack_require__(/*! @/components/free-ui/free-avatar.vue */ 44));\nvar _freeConfirm = _interopRequireDefault(__webpack_require__(/*! @/components/free-ui/free-confirm.vue */ 88));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { name: '', components: { FreeNavBar: _freeNavBar.default, FreeListItem: _freeListItem.default, FreeAvatar: _freeAvatar.default, FreeConfirm: _freeConfirm.default }, props: {}, data: function data() {return { // 用户信息数据\n      user: { avatar: '/static/images/demo/demo6.jpg', nickname: '张波2', username: 'zhangbo3714' }, // 修改昵称的内容\n      newNickname: \"\", // 修改账号的内容\n      newUsername: \"\" };}, computed: {}, watch: {}, created: function created() {}, mounted: function mounted() {}, methods: { // 更新用户信息\n    update: function update(e) {var _this = this;switch (e) {case 'avatar': // 选择图片\n          uni.chooseImage({ count: 1, sizeType: ['compressed'], success: function success(res) {_this.user.avatar = res.tempFilePaths[0];\n            } });\n\n          break;\n        case 'code':\n          // 跳转二维码名片页面\n          break;\n\n        case 'nickname':\n          this.newNickname = this.user.nickname;\n          this.$refs.nicknameConfirm.show(function (close) {\n            if (!_this.newNickname) {\n              return uni.showToast({\n                title: '昵称不能为空!',\n                icon: 'none' });\n\n            }\n            _this.user.nickname = _this.newNickname;\n            // 关闭弹出层\n            close();\n            uni.showToast({\n              title: '昵称更新成功' });\n\n          });\n          break;\n        case 'username':\n          this.newUsername = this.user.username;\n          this.$refs.usernameConfirm.show(function (close) {\n            if (!_this.newUsername) {\n              return uni.showToast({\n                title: '用户名不能为空!',\n                icon: 'none' });\n\n            }\n            _this.user.username = _this.newUsername;\n            // 关闭弹出层\n            close();\n            uni.showToast({\n              title: '用户名更新成功' });\n\n          });\n          break;\n          break;\n        default:\n          break;}\n\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///21\n");
