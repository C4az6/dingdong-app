              ...
              [
                _vm.item.type === "text"
                  ...
                  ? _c("u-image", {
                      ...
                      attrs: { src: _vm.item.data, lazyLoad: true },
                      on: {
                        click: function($event) {
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _freeAvatar = _interopRequireDefault(__webpack_require__(/*! @/components/free-ui/free-avatar.vue */ 41));\nvar _time = _interopRequireDefault(__webpack_require__(/*! @/common/free-lib/time.js */ 46));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { name: 'FreeChatItem', components: { FreeAvatar: _freeAvatar.default }, props: { item: { type: Object, required: true }, index: { type: [Number, String], required: true }, pretime: { type: [Number, String], required: true, default: 0 } }, data: function data() {return { w: 100, h: 100 };}, computed: { // 是否需要气泡样式\n    hasLabelClass: function hasLabelClass() {// 短路运算，如果前者为true则返回前者的表达式，如果前者为false，则返回后者的表达式,只有 text 和 audio 类型才需要气泡\n      return this.item.type === 'text' || this.item.type === 'audio';}, // 气泡样式\n    labelClass: function labelClass() {var label = this.hasLabelClass ? 'mr-3 bg-chat-item' : 'mr-3 border';return this.isSelf ? label : 'bg-white ml-3';}, // 利用计算属性减少模版的判断代码，例如v-if\n    isSelf: function isSelf() {var id = 1; // 假设用户本身的id为1\n      return this.item.user_id === id;},\n    // 显示时间\n    showTime: function showTime() {\n      return _time.default.getChatTime(this.item.create_time, this.pretime);\n    } },\n\n  watch: {\n    // 监听是否撤回消息\n    'item.isRemove': {\n      handler: function handler(newValue, oldValue) {var _this = this;\n\n        if (newValue) {\n          var animation = weex.requireModule('animation');\n          this.$nextTick(function () {\n            animation.transition(_this.$refs.isRemove, {\n              styles: {\n                opacity: 1 },\n\n              duration: 300,\n              timingFunction: 'ease' });\n\n          });\n        }\n\n      },\n      immediate: true } },\n\n\n  created: function created() {},\n  mounted: function mounted() {},\n  methods: {\n    // 聊天信息的图片加载完成\n    loadImage: function loadImage(e) {\n      __f__(\"log\", \"e: \", e, \" at components/free-ui/free-chat-item.vue:117\");\n      var w = e.detail.width;\n      var h = e.detail.height;\n      // 最大宽度作为基准的写法\n      // let maxW = uni.upx2px(500)\n      // if( w <= maxW ) {\n      // \t// 使用原来的宽和高\n      // \tthis.w = w\n      // \tthis.h = h\n      // \treturn;\n      // }\n      // /* \n      // \t计算公式：\n      // \tw / h = maxW / maxH\n      // \tmaxH = maxW * h/w\n      //  */\n      // this.w = maxW\n      // this.h = maxW * (h/w)\n\n      // 最大高度作为基准的写法\n      var maxW = uni.upx2px(500);\n      var maxH = uni.upx2px(350);\n      if (h <= maxH) {\n        this.h = h;\n        this.w = w <= maxW ? w : maxW;\n        return;\n      }\n      this.h = maxH;\n      // 计算等比例的最大宽度，赋值给w2变量\n      var w2 = maxH * (w / h);\n      // 如果等比例最大宽度小于之前定义的最大宽度则使用w2，否则使用之前定义的最大宽度\n      this.w = w2 <= maxW ? w2 : maxW;\n    },\n    // 长按事件\n    long: function long(e) {\n      var x = 0;\n      var y = 0;\n\n      if (Array.isArray(e.changedTouches) && e.changedTouches.length > 0) {\n        x = e.changedTouches[0].screenX;\n        y = e.changedTouches[0].screenY;\n      }\n\n\n\n\n\n\n\n      this.$emit('long', { x: x, y: y, index: this.index });\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 18)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///40\n");
